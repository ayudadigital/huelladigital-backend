...
public class ChangeReviewPendingProposalToPublishedActionShould {
    ...
    void send_change_email() {
        ...
        when(proposalService.changeStatusToPublished(dto.getIdProposal())).thenReturn(new ChangeStatusToPublishedResult("contacperson@gmail.com",true, "Recogida de ropita"));
